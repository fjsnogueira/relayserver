...
namespace Thinktecture.Relay.Server.Diagnostics
{
    public class RequestLogger : IRequestLogger
    {
        ...
        public void LogRequest(IOnPremiseConnectorRequest onPremiseConnectorRequest, IOnPremiseTargetReponse onPremiseTargetReponse,
            HttpStatusCode responseStatusCode, Guid linkId, string originId, string relayPath)
        {
