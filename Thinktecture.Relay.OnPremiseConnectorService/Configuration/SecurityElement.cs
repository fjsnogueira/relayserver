...
namespace Thinktecture.Relay.OnPremiseConnectorService.Configuration
{
    ...
    {
        private static readonly ConfigurationProperty _authenticationType = new ConfigurationProperty("authenticationType",
            typeof(AuthenticationType), AuthenticationType.None, ConfigurationPropertyOptions.IsRequired);
